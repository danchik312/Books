...
urlpatterns = [
    ...
    path('Books_list/<int:id>/', views.BooksDetailView.as_view(), name='BooksDetailView'),

    path('Books_list/<int:id>/delete/', views.DeleteBooksView.as_view(), name='DeleteBooksView'),
    path('Books_list/<int:id>/update/', views.EditBooksView.as_view(), name='EditBooksView'),
