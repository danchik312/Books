...
class AnimeFan(User):
    ...
    years_of_exp = models.PositiveIntegerField(default=18, validators=[MaxValueValidator(99), MinValueValidator(5)])
    gender = models.CharField(max_length=100, choices=GENDER)
    bio = models.FileField(upload_to='media/biography/', verbose_name='Загрузите свою биографию', null=True, blank=True)
    ...
    image = models.ImageField(upload_to='images/', verbose_name='Загрузите ваше фото', null=True)

    preferred_content = models.CharField(max_length=100, choices=CONTENT,
                                          verbose_name='Укажите предпочитаемый контент', null=True)
